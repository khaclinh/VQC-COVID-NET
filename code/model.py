...
class CovidNet(nn.Module):
    def __init__(self, bnd=False, bna=False, label_smoothing=False,
                 n_classes=2, hidden_size=1024, emmbedding_size=128, n_embeddings=1024, beta=.25):
        ...
        self.vector_quantization = VectorQuantizer(
            n_embeddings, emmbedding_size, beta)
    ...
    def forward(self, x, site):
        ...
        # logits = self.classifier(feature2)

        return logits, feature2, embedding_loss
